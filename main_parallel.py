...
def define_parser():
    ...
    parser.add_argument("--learning_rate_RB", type=float, default=10**(-5), help="Learning rate for back propagation")
    ...
    parser.add_argument("--initialization", default="On", help="Unit variance random initialization")
...
if __name__ == '__main__':
    ...
    # csfont = {'fontname':'sans-serif'}
    # plt.subplots()
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic[str(500)], 'b-', label="n = 500")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic[str(1000)], 'r-', label="n = 1000")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic[str(1500)], 'g-', label="n = 1500")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic[str(2000)], 'm-', label="n = 2000")
    # plt.legend(loc='best')
    # plt.xlabel("Number of epochs",fontdict=csfont)
    # plt.ylabel("Training loss",fontdict=csfont)
    # plt.title("MNIST, Multilayer Neural Network", loc='center')
    # plt.savefig(result_path + "MLP_TrainLoss.png")
    # plt.close()

    # plt.subplots()
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic[str(500)], 'b-', label="n = 500")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic[str(1000)], 'r-', label="n = 1000")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic[str(1500)], 'g-', label="n = 1500")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic[str(2000)], 'm-', label="n = 2000")
    # plt.legend(loc='best')
    # plt.xlabel("Number of epochs",fontdict=csfont)
    # plt.ylabel("Testing loss",fontdict=csfont)
    # plt.title("MNIST, Multilayer Neural Network", loc='center')
    # plt.savefig(result_path + "MLP_TestLoss.png")
    # plt.close()

    # plt.subplots()
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic[str(500)], 'b-', label="n = 500")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic[str(1000)], 'r-', label="n = 1000")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic[str(1500)], 'g-', label="n = 1500")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic[str(2000)], 'm-', label="n = 2000")
    # plt.legend(loc='best')
    # plt.xlabel("Number of epochs",fontdict=csfont)
    # plt.ylabel("Testing Accuracy",fontdict=csfont)
    # plt.title("MNIST, Multilayer Neural Network", loc='center')
    # plt.savefig(result_path + "MLP_TestAcc.png")
    # plt.close()
    ...
    for Myactivation in activation_list:
        for Myloss in Loss_list:
            # CNN(Myloss,Myactivation)

            RB_hparameters["learning_rate_RB"]=learning_rate
            RB_hparameters["batchSize_RB"]=batchSize
            RB_hparameters["optimizer_RB"]=MyOptimizer
            RB_hparameters["architecture_name"] = "weights_CNN_"+Myloss+"_"+Myactivation
    ...
    csfont = {'fontname':'sans-serif'}
    plt.subplots()
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["softmax"], 'b-', label="softmax")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["sigmoid"], 'r-', label="sigmoid")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["softplus"], 'g-', label="softplus")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["exponential"], 'm-', label="exponential")
    plt.legend(loc='best')
    plt.xlabel("Number of epochs",fontdict=csfont)
    plt.ylabel("Training loss",fontdict=csfont)
    plt.title("CIFAR-10, Convolutional Neural Network", loc='center')
    ...
    plt.savefig(result_path + "CNN_TrainLoss_activations.png")    
    plt.close()

    plt.subplots()
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["softmax"], 'b-', label="softmax")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["sigmoid"], 'r-', label="sigmoid")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["softplus"], 'g-', label="softplus")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["exponential"], 'm-', label="exponential")
    plt.legend(loc='best')
    plt.xlabel("Number of epochs",fontdict=csfont)
    plt.ylabel("Testing loss",fontdict=csfont)
    plt.title("CIFAR-10, Convolutional Neural Network", loc='center')
    plt.savefig(result_path + "CNN_TestLoss_activations.png")
    plt.close()

    plt.subplots()
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["softmax"], 'b-', label="softmax")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["sigmoid"], 'r-', label="sigmoid")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["softplus"], 'g-', label="softplus")
    plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["exponential"], 'm-', label="exponential")
    plt.legend(loc='best')
    plt.xlabel("Number of epochs",fontdict=csfont)
    plt.ylabel("Testing Accuracy",fontdict=csfont)
    plt.title("CIFAR-10, Convolutional Neural Network", loc='center')
    plt.savefig(result_path + "CNN_TestAcc_activations.png")
    plt.close()
    ...
    # csfont = {'fontname':'sans-serif'}
    # plt.subplots()
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["categorical_crossentropy"], 'b-', label="CE")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["MSE"], 'r-', label="MSE")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["poisson"], 'g-', label="Poisson")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), train_loss_dic["Huber"], 'm-', label="Huber")
    # plt.legend(loc='best')
    # plt.xlabel("Number of epochs",fontdict=csfont)
    # plt.ylabel("Training loss",fontdict=csfont)
    # plt.title("CIFAR-10, Convolutional Neural Network", loc='center')
    # # plt.savefig(data_path +"TrainLoss_vs_epoch_"+MyOptimizer+"_batch_" \
    # #     +str(RB_hparameters["batchSize_RB"])+"_epoch_"+str(RB_hparameters["Epoch_num_RB"])+".png")
    # plt.savefig(result_path + "CNN_TrainLoss.png")    
    # plt.close()

    # plt.subplots()
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["categorical_crossentropy"], 'b-', label="CE")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["MSE"], 'r-', label="MSE")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["poisson"], 'g-', label="Poisson")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_loss_dic["Huber"], 'm-', label="Huber")
    # plt.legend(loc='best')
    # plt.xlabel("Number of epochs",fontdict=csfont)
    # plt.ylabel("Testing loss",fontdict=csfont)
    # plt.title("CIFAR-10, Convolutional Neural Network", loc='center')
    # plt.savefig(result_path + "CNN_TestLoss.png")
    # plt.close()

    # plt.subplots()
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["categorical_crossentropy"], 'b-', label="CE")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["MSE"], 'r-', label="MSE")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["poisson"], 'g-', label="Poisson")
    # plt.plot(range(0, RB_hparameters["Epoch_num_RB"]), test_acc_dic["Huber"], 'm-', label="Huber")
    # plt.legend(loc='best')
    # plt.xlabel("Number of epochs",fontdict=csfont)
    # plt.ylabel("Testing Accuracy",fontdict=csfont)
    # plt.title("CIFAR-10, Convolutional Neural Network", loc='center')
    # plt.savefig(result_path + "CNN_TestAcc.png")
    # plt.close()
